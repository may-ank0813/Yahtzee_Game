...
class Rule {
  // all below class inherit this constructor(so we don't need to make contructor for them seperately)
  // This a method to easily add the values of the parameters of a class to their respective class fields 
  // where a class implements that interface or at least has a partial implantation of that interface.
  constructor(params) {
...
{ 
  // evalRoll is a function which returns score for every possible case
  evalRoll = dice => {
...
// 1234,2345,3456 (cases for small straight) four in a row
...
class LargeStraight extends Rule {
  evalRoll = dice => {
    ...
    // if both 1 and 6 are present then it become false
